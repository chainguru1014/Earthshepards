...
pub fn compact_code_unwrap() -> &'static [u8] {
	shear_runtime::WASM_BINARY.expect(
...
const TRANSACTION_VERSION: u32 = shear_runtime::VERSION.transaction_version;

const SPEC_VERSION: u32 = shear_runtime::VERSION.spec_version;
