...
use shear_runtime::{
	constants::currency::SHEAR, AccountId, BalancesCall, Call, CheckedExtrinsic, MinimumPeriod,
				...
				function: match self.content.block_type {
					...
					BlockType::RandomTransfersReaping => {
						Call::Balances(BalancesCall::transfer {
							...
							value: 100 * SHEAR - (shear_runtime::ExistentialDeposit::get() - 1),
						})
					},
...
impl BenchKeyring {
	...
	pub fn generate_genesis(&self) -> shear_runtime::GenesisConfig {
		crate::genesis::config_endowed(
			Some(shear_runtime::wasm_binary_unwrap()),
